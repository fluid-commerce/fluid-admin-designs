...
const colors = {
  ...
  blue: [
    "[--switch-bg-ring:theme(colors.blue.600/90%)] [--switch-bg:theme(colors.blue.500)] dark:[--switch-bg-ring:transparent]",
    "[--switch:white] [--switch-ring:theme(colors.blue.600/90%)] [--switch-shadow:theme(colors.blue.900/20%)]",
  ],
  violet: [
